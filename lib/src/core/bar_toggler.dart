...
class _SideBarTogglerWidgetState extends State<SideBarTogglerWidget> {
  ...
  Widget build(BuildContext context) {
    return IconButton(
      icon: Icon(
        widget.expanded ? widget.togglerData.shrinkIcon : widget.togglerData.expandIcon,
        color: widget.expanded ? widget.togglerTheme.shrinkIconColor : widget.togglerTheme.expandIconColor,
      ),
