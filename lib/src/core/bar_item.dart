              ...
              child: Padding(
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      Padding(
                        padding: const EdgeInsets.only(left: Dimens.grid_1_6),
                        child: Icon(
                      ...
                      Padding(
                        padding:
                            EdgeInsets.only(left: MediaQuery.of(context).orientation == Orientation.portrait ? 0 : 10),
                        child: Text(
                          MediaQuery.of(context).orientation == Orientation.portrait ? '' : widget.itemData.label,
